...
Easing functions help to give a *dynamic* to transition. In [Cartesian](../geometry/units.md#cartesian) terms, they give a _y_ value for _x_ (where x is 0 .. 1). Or in temporal terms, you can think of them as giving a value at time _t_ (where _t_ is 0 .. 1).
