  ...
  <button title="Copy envelope data to clipboard" @click="${this._copy}">Copy envelope</button>
    ...
    `}render(){const t={expanded:this.expanded};return h`
      <div class=${$(t)}>
        ...
        `}}H([b({type:Boolean})],P.prototype,"expanded",2);customElements.define(J,P);const o=document.getElementById("envDataLog"),f=g.plot("#envData",{capacity:300,defaultSeriesVariable:"accent",x:{...g.defaultAxis("x"),showLine:!1},y:{...g.defaultAxis("y"),showLine:!1,colour:D.getCssVariable("fg","grey")},lineWidth:3,autoSizeCanvas:!0,debug:!1});let y=!1,w={...m(),attackBend:1,decayBend:-1,releaseBend:1},l=_({...w,shouldLoop:y});l.addEventListener("change",e=>{d.button("#btnRelease").disabled=e.newState!=="sustain"});d.button("#btnTriggerHold",()=>{o.clear(),l.trigger(!0),p()});d.button("#btnRelease",()=>{l.release()});d.button("#btnTrigger",()=>{o.clear(),l.trigger(),p()});const M=d.select("#selectShow",e=>{f.clear(),o.log(""),p()});S(F("#envEditor"),"change").pipe(R(e=>e.detail),T(1e3)).subscribe(e=>{w=e,x()});const x=()=>{try{l=_({...w,shouldLoop:y}),l.trigger(),o.clear(),f.clear(),p()}catch(e){o.error(e)}};d.checkbox("#chkLooping",e=>{y=e,x()});let u=!1;const p=()=>{if(u)return;const e=function(){let[t,s,a]=l.compute();if(a<0)debugger;if(t===void 0){u=!1;return}const i=M.value==="raw"?a:s;f.add(i),o.log(`${t} ${i.toFixed(3)}`),l.isDone?(console.log("Envelope done"),u=!1):(u=!0,window.requestAnimationFrame(e))};window.requestAnimationFrame(e)};x();
