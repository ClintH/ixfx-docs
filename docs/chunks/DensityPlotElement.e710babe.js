import{b as s,r,t as debounce,v as continuously,K as repeat,N as Normalise_exports,C as Colour_exports,L as Ellipse_exports,D as Drawing_exports,$,o,a as e}from"../client-shim.9530acfc.js";import{e as elStyles}from"./styles.b6bfd690.js";var __defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(t,i,n,l)=>{for(var a=l>1?void 0:l?__getOwnPropDesc(i,n):i,c=t.length-1,p;c>=0;c--)(p=t[c])&&(a=(l?p(i,n,a):p(a))||a);return l&&a&&__defProp(i,n,a),a};const tagName="density-plot-element";class DensityPlotElement extends s{static styles=[elStyles,r`
      #container {
        display: flex;
