import{c as s,g as i,f as y,o,a as e}from"../client-shim.ef70acef.js";import{e as debounce,g as continuously,m as repeat,N as Normalise_exports,C as Colour_exports,n as Ellipse_exports,D as Drawing_exports}from"./chunk-G5YZ6YRD.f1c136d9.js";import{e as elStyles}from"./styles.1b7f352c.js";var __defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(t,n,l,r)=>{for(var a=r>1?void 0:r?__getOwnPropDesc(n,l):n,c=t.length-1,p;c>=0;c--)(p=t[c])&&(a=(r?p(n,l,a):p(a))||a);return r&&a&&__defProp(n,l,a),a};const tagName="density-plot-element";class DensityPlotElement extends s{static styles=[elStyles,i`
      #container {
        display: flex;
