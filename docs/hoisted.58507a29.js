import{g as L,f as k}from"./chunks/chunk-HYVQIQVS.ac4108eb.js";import"./chunks/chunk-OMXZMOOU.e9ad33f4.js";import"./chunks/chunk-TSWQ4JT6.e4dc2800.js";import"./chunks/chunk-PHF3FPUO.fbbc39e3.js";import{T as E}from"./chunks/chunk-QIWUQGQJ.e6594f26.js";import"./chunks/chunk-QAZYUFOI.8a9663bc.js";import{l as I}from"./chunks/chunk-SJVFW73P.e7d5b176.js";import"./chunks/chunk-DTRNDG6C.d0f370a4.js";import"./chunks/chunk-HGDBKEIQ.5ba97fe9.js";import"./chunks/chunk-XFTV7E35.542cf193.js";import"./chunks/chunk-U4IZE4J2.68fe18db.js";import{b,h as n,a as T,c as q,d as x}from"./chunks/chunk-FQLUQVDZ.735c98e3.js";import{h as C,j as c,k as H,p as o,q as j,t as B}from"./client-shim.cda72367.js";import"./chunks/ReplPad.61b87e42.js";var D=t=>{if(!(t==null||t==="undefined"))try{if(typeof t=="string"){if(t.length===0)return;const e=JSON.parse(t);if(!Array.isArray(e)){console.error("Histogram innerText should be JSON array");return}for(let r=0;r<e.length;r++){if(!Array.isArray(e[r])){console.error("Histogram array should consist of inner arrays");return}if(e[r].length!==2){console.error("Histogram inner arrays should consist of two elements");return}if(typeof e[r][0]!="string"){console.error(`First element of inner array should be a string (index ${r})`);return}if(typeof e[r][1]!="number"){console.error(`Second element of inner array should be a number (index ${r})`);return}}return e}}catch(e){console.log(t),console.error(e)}},i=class extends H{constructor(){super();this.data=[],this.showDataLabels=!0,this.height="100%",this.showXAxis=!0,this.json=void 0}connectedCallback(){this.hasAttribute("json")||this.setAttribute("json",this.innerText),super.connectedCallback()}barTemplate(t,e,r){const{percentage:g}=t,[p,m]=t.data,v=1,s=2,l=e+1,y=l+1,S=o`<div class="data">${m}</div>`,_=o`${p}`;return o`
