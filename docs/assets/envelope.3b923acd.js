...
<div class="toolbar centered mini">
  ...
  <button title="Copy envelope data to clipboard" @click="${this._copy}">Copy envelope</button>
...
</div>`}},o(b,"styles",[E]),b);p([S("#attackPreview")],u.prototype,"attackPreview",2);p([y()],u.prototype,"data",2);p([y({converter:J,type:Object})],u.prototype,"json",2);u=p([T("envelope-editor")],u);var M=Object.defineProperty,G=Object.getOwnPropertyDescriptor,K=(e,t,i,a)=>{for(var s=a>1?void 0:a?G(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(a?r(t,i,s):r(s))||s);return a&&s&&M(t,i,s),s};const Q="log-element";class w extends C{constructor(){super();o(this,"logger");o(this,"logContainer");this.logger=null,this.logContainer=null}init(){this.logContainer===null&&(this.logContainer=this.shadowRoot.querySelector("#stream"),this.logContainer!==null&&(this.logger=U(this.logContainer,{minIntervalMs:20,capacity:150})))}error(t){this.init(),this.logger!==null?(this.logger.error(t),this.updateLog()):console.error(t)}clear(){this.logger!==null&&(this.logger.clear(),this.requestUpdate(),this.updateLog())}log(t){this.init(),this.logger!==null?(this.logger.log(t),this.updateLog()):console.log(t)}toggleExpand(){this.expanded=!this.expanded}updateLog(){const t=this.shadowRoot.querySelector(".toolbar");t!==null&&(this.isEmpty?t.classList.add("empty"):t.classList.remove("empty"))}get isEmpty(){return this.init(),this.logger!==null?this.logger.isEmpty:!0}renderTools(){return v`
    ...
    `]);K([y({type:Boolean})],w.prototype,"expanded",2);customElements.define(Q,w);const d=document.getElementById("envDataLog"),x=m.plot("#envData",{capacity:300,x:{...m.defaultAxis("x"),showLine:!1},y:{...m.defaultAxis("y"),showLine:!1,colour:P.getCssVariable("fg","grey")},lineWidth:3,autoSizeCanvas:!0,debug:!1});let $=!1,L={...f(),attackBend:1,decayBend:-1,releaseBend:1},l=B({...L,shouldLoop:$});l.addEventListener("change",e=>{c.button("#btnRelease").disabled=e.newState!=="sustain"});c.button("#btnTriggerHold",()=>{d.clear(),l.trigger(!0),g()});c.button("#btnRelease",()=>{l.release()});c.button("#btnTrigger",()=>{d.clear(),l.trigger(),g()});const X=c.select("#selectShow",e=>{x.clear(),d.log(""),g()});q(z("#envEditor"),"change").pipe(F(e=>e.detail),j(1e3)).subscribe(e=>{L=e,k()});const k=()=>{try{l=B({...L,shouldLoop:$}),l.trigger(),d.clear(),x.clear(),g()}catch(e){d.error(e)}};c.checkbox("#chkLooping",e=>{$=e,k()});let h=!1;const g=()=>{if(h)return;const e=function(){let[t,i,a]=l.compute();if(a<0)debugger;if(t===void 0){h=!1;return}const s=X.value==="raw"?a:i;x.add(s),d.log(`${t} ${s.toFixed(3)}`),l.isDone?(console.log("Envelope done"),h=!1):(h=!0,window.requestAnimationFrame(e))};window.requestAnimationFrame(e)};k();
