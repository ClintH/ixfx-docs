import{t as l,u as s,v as c,w as m,x as u,z as G}from"./vendor.aa1ac2c8.js";var e=Object.freeze,p=Object.defineProperty,f=(r,t)=>e(p(r,"raw",{value:e(t||r.slice())})),n;l("/src/pages/geometry/GridDataPlay.astro",{modules:[],hydratedComponents:[],hydrationDirectives:new Set([]),hoisted:[]});const b=s("/src/pages/geometry/GridDataPlay.astro","https://clinth.github.io/ixfx-docs/","file:///C:/Users/ch/Documents/Repos/ixfx-docs/");c(async(r,t,o)=>{const a=r.createAstro(b,t,o),d=[{props:{"data-astro-id":"YYDL52DE"},children:"#dataGrid.astro-YYDL52DE{--grid-color:var(--divider);--hover-color: var(--bg-contrast);}#dataGridSection.astro-YYDL52DE{display:flex;background-color:aliceblue;border:2px solid black;flex-direction:column;color:black;padding:1em;max-width:350px;margin:0 auto;align-items:center;}"}];for(const i of d)r.styles.add(i);return m(n||(n=f(['<html class="astro-YYDL52DE"><head><script type="module"',`><\/script>
...
</body></html>`])),G(a.resolve("../../components/GridEditor.ts"),"src"),u(r,"grid-editor","grid-editor",{rows:"15",cols:"15",pixelSize:"20",id:"dataGrid",class:"astro-YYDL52DE"}))});
