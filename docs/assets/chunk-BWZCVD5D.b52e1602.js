import{_ as k,r as p,c as M,g as C,h as z,i as I,j as N,p as T,k as H,t as R,w as j,l as A,m as E}from"./chunk-25RM45LF.6197efee.js";var L={};k(L,{button:()=>O,checkbox:()=>_,numeric:()=>F,select:()=>B});var _=(o,n)=>{const t=p(o);return n&&t.addEventListener("change",()=>{n(t.checked)}),{get checked(){return t.checked},set checked(e){t.checked=e}}},F=(o,n,t)=>{const e=p(o),i=t?"change":"input";return n&&e.addEventListener(i,()=>{n(parseInt(e.value))}),{get value(){return parseInt(e.value)},set value(c){e.value=c.toString()}}},O=(o,n)=>{const t=p(o);return n&&t.addEventListener("click",e=>{n()}),{click(){n&&n()},set disabled(e){t.disabled=e}}},B=(o,n,t={})=>{const e=p(o),{placeholderOpt:i,shouldAddChoosePlaceholder:c=!1,autoSelectAfterChoice:d=-1}=t,l=()=>{n!==void 0&&n(e.value),d>=0&&(e.selectedIndex=d)};return n&&e.addEventListener("change",a=>{l()}),{set disabled(a){e.disabled=a},get value(){return e.value},get index(){return e.selectedIndex},get isSelectedPlaceholder(){return(c||t.placeholderOpt!==void 0)&&e.selectedIndex===0},setOpts(a,m){e.options.length=0,c?a=["-- Choose --",...a]:i!==void 0&&(a=[i,...a]);let S=0;a.forEach((g,u)=>{const h=document.createElement("option");h.value=g,h.innerHTML=g,m!==void 0&&g===m&&(S=u),e.options.add(h)}),e.selectedIndex=S},select(a=0,m=!1){e.selectedIndex=a,m&&n&&l()}}},D={};k(D,{Forms:()=>L,copyToClipboard:()=>M,createAfter:()=>C,createIn:()=>z,fullSizeCanvas:()=>I,log:()=>V,parentSize:()=>N,parentSizeCanvas:()=>T,resizeObservable:()=>H,resolveEl:()=>p,rx:()=>q,themeChangeObservable:()=>R,windowResize:()=>j});var P=(o,n)=>{const t=document.createElement("style");t.textContent=n;let e;return o.shadowRoot?(e=o.shadowRoot,e.innerHTML=""):e=o.attachShadow({mode:"open"}),e.appendChild(t),e},V=(o,n={})=>{const{capacity:t=0,monospaced:e=!0,timestamp:i=!1,collapseDuplicates:c=!0}=n;let d=0,l,a=0;const m=p(o),g=P(m,`
  .log {
