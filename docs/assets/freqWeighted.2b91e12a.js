import{g as j,f as L,R as _}from"./bundle.213777ea.js";import{l as E}from"./chunk-DIQ6ZWAQ.94b98cf2.js";import{b as x,n as i,a as H,c as I,d as b}from"./chunk-EGNKYH6P.1933f072.js";import"./chunk-5JM3IB7G.99fc65d7.js";import{a as B,b as c,c as C,g as o,h as T,i as D}from"./vendor.aa1ac2c8.js";import"./chunk-DBBTHACN.e5311635.js";import"./chunk-HCHJFXUB.cd82ab14.js";import"./chunk-AGSKCOEP.dcc7b64e.js";import"./chunk-2NL2I57L.fde27681.js";import"./chunk-GAMNYXM7.7acacbe3.js";var M=t=>{if(!(t==null||t==="undefined"))try{if(typeof t=="string"){if(t.length===0)return;const e=JSON.parse(t);if(!Array.isArray(e)){console.error("Histogram innerText should be JSON array");return}for(let r=0;r<e.length;r++){if(!Array.isArray(e[r])){console.error("Histogram array should consist of inner arrays");return}if(e[r].length!==2){console.error("Histogram inner arrays should consist of two elements");return}if(typeof e[r][0]!="string"){console.error(`First element of inner array should be a string (index ${r})`);return}if(typeof e[r][1]!="number"){console.error(`Second element of inner array should be a number (index ${r})`);return}}return e}}catch(e){console.log(t),console.error(e)}},a=class extends C{constructor(){super();this.data=[],this.showDataLabels=!0,this.height="100%",this.showXAxis=!0,this.json=void 0}connectedCallback(){this.hasAttribute("json")||this.setAttribute("json",this.innerText),super.connectedCallback()}barTemplate(t,e,r){const{percentage:g}=t,[u,p]=t.data,v=1,s=2,l=e+1,y=l+1,k=o`<div class="data">${p}</div>`,S=o`${u}`;return o`
  ...
  `);i([c()],a.prototype,"data",2);i([c()],a.prototype,"showDataLabels",2);i([c()],a.prototype,"height",2);i([c()],a.prototype,"showXAxis",2);i([c({converter:M,type:Object})],a.prototype,"json",2);a=i([D("histogram-vis")],a);var d,N=class{constructor(t){x(this,"el"),H(this,d,void 0),this.el=t}setAutoSort(t){I(this,d,j(t))}clear(){this.el!==void 0&&(this.el.data=[])}dispose(){const t=this.el;t!==void 0&&t.remove()}update(t){if(this.el===void 0){console.warn("FrequencyHistogramPlot this.el undefined");return}b(this,d)!==void 0?this.el.data=b(this,d).call(this,t):this.el.data=[...t]}};d=new WeakMap;const n=E("#dataStream",{capacity:8,timestamp:!1}),h=L(),w=new N(document.getElementById("dataPlot"));w.setAutoSort("valueReverse");let m=200,f=0;h.addEventListener("change",()=>{w.update(h.toArray())});const A=()=>{n.log("Start"),n.log(),f=window.setInterval(()=>{m--;const t=_.weighted(1,100).toString();h.add(t),n.log(t.toString()),m<=0&&$()},1e3)},$=()=>{f!==0&&(n.log("Stop"),n.log(),m=200,window.clearInterval(f))},X=()=>{h.clear(),n.log()};document.getElementById("btnStart").addEventListener("click",A);document.getElementById("btnStop").addEventListener("click",$);document.getElementById("btnClear").addEventListener("click",X);A();
