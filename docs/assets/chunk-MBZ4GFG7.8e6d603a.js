import{e as k,r as p,f as M,g as C,h as z,i as I,p as N,j as T,k as H,t as j,w as A,l as R,m as E}from"./chunk-V6WGO73W.4b0edf4f.js";var w={};k(w,{button:()=>F,checkbox:()=>O,numeric:()=>_,select:()=>B});var O=(o,n)=>{const t=p(o);return n&&t.addEventListener("change",()=>{n(t.checked)}),{get checked(){return t.checked},set checked(e){t.checked=e}}},_=(o,n,t)=>{const e=p(o),i=t?"change":"input";return n&&e.addEventListener(i,()=>{n(parseInt(e.value))}),{get value(){return parseInt(e.value)},set value(c){e.value=c.toString()}}},F=(o,n)=>{const t=p(o);return n&&t.addEventListener("click",e=>{n()}),{click(){n&&n()},set disabled(e){t.disabled=e}}},B=(o,n,t={})=>{const e=p(o),{placeholderOpt:i,shouldAddChoosePlaceholder:c=!1,autoSelectAfterChoice:d=-1}=t,l=()=>{n!==void 0&&n(e.value),d>=0&&(e.selectedIndex=d)};return n&&e.addEventListener("change",a=>{l()}),{set disabled(a){e.disabled=a},get value(){return e.value},get index(){return e.selectedIndex},get isSelectedPlaceholder(){return(c||t.placeholderOpt!==void 0)&&e.selectedIndex===0},setOpts(a,m){e.options.length=0,c?a=["-- Choose --",...a]:i!==void 0&&(a=[i,...a]);let S=0;a.forEach((g,u)=>{const b=document.createElement("option");b.value=g,b.innerHTML=g,m!==void 0&&g===m&&(S=u),e.options.add(b)}),e.selectedIndex=S},select(a=0,m=!1){e.selectedIndex=a,m&&n&&l()}}},D={};k(D,{Forms:()=>w,copyToClipboard:()=>M,createAfter:()=>C,createIn:()=>z,fullSizeCanvas:()=>I,log:()=>W,parentSize:()=>N,parentSizeCanvas:()=>T,resizeObservable:()=>H,resolveEl:()=>p,rx:()=>P,themeChangeObservable:()=>j,windowResize:()=>A});var V=(o,n)=>{const t=document.createElement("style");t.textContent=n;let e;return o.shadowRoot?(e=o.shadowRoot,e.innerHTML=""):e=o.attachShadow({mode:"open"}),e.appendChild(t),e},W=(o,n={})=>{const{capacity:t=0,monospaced:e=!0,timestamp:i=!1,collapseDuplicates:c=!0}=n;let d=0,l,a=0;const m=p(o),g=V(m,`
  .log {
